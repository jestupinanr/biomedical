...
function EmployeeButton({ link, gradient }: EmployeeButtonProps) {
  return (
    <Button
      ...
      className={`w-full bg-linear-to-r ${gradient} hover:opacity-90 text-white rounded-full py-6 shadow-md hover:shadow-lg transition-all duration-300 border-0 relative overflow-hidden group/btn cursor-pointer`}
    >

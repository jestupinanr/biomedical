...
function ButtonSoftware({ textButton }: ButtonSoftwareProps) {
  return (
    <Button
      ...
      className="bg-white text-[#1173bc] hover:bg-white/90 rounded-xl px-8 py-6 shadow-lg hover:shadow-xl transition-all inline-flex items-center gap-2 cursor-pointer text-sm md:text-base"
    >
      {textButton}

  ...
  return (
    <section className="py-24 bg-white dark:bg-[#050514]" id="contact">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Floating Circles */}
        <div className="absolute top-24 right-32 w-64 h-64 bg-gradient-to-br from-[#24aae1]/7 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-32 left-24 w-96 h-96 bg-gradient-to-tr from-[#1173bc]/6 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card className="rounded-[24px] border-[#E5E7EB] shadow-sm bg-gradient-to-br from-[#2f3092] to-[#1173bc] text-white dark:border-white/10 flex-1">
              <CardHeader>
              ...
              <CardContent className="space-y-5">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#24aae1] to-[#1173bc] rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-[#1D3DF8]/30">
            ...
            <Card className="rounded-[24px] border-[#E5E7EB] shadow-sm bg-gradient-to-r from-[#24aae1] to-[#1173bc] text-white dark:border-white/10 flex-1">
              <CardHeader>
